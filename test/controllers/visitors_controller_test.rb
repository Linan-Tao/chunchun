...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { headshot: @visitor.headshot, nickname: @visitor.nickname, uid: @visitor.uid } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { headshot: @visitor.headshot, nickname: @visitor.nickname, uid: @visitor.uid } }
